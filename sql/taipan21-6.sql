...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2015 at 01:17 AM
...
(20, 1231257, 'Marvin$nbspTim', 1, 1, '0000-00-00'),
(21, 1231258, 'wakkaka$nbsp;asda', 1, 1, '0000-00-00'),
(22, 1231259, 'fergy huang', 1, 0, '2015-06-20'),
(23, 1231277, 'test', 1, 0, '2015-06-21');
...
`m_no` int(11) NOT NULL,
  `m_fname` varchar(40) NOT NULL,
  `m_lname` varchar(40) NOT NULL,
  `m_idtype` varchar(10) NOT NULL,
  `m_idno` varchar(200) NOT NULL,
  `m_address` varchar(255) NOT NULL,
  `m_city` varchar(50) NOT NULL,
  `m_zip` int(11) NOT NULL,
  `m_dob` varchar(50) NOT NULL,
...
INSERT INTO `member` (`m_no`, `m_fname`, `m_lname`, `m_idtype`, `m_idno`, `m_address`, `m_city`, `m_zip`, `m_dob`, `m_phone`, `m_pin`, `m_email`, `card_id`) VALUES
(5, 'Marvin', 'Tim', 'ktp', '0123123123', '', '', 0, '30-March-1990', '0819890062', '351fea', 'merkurius@romania.com', 1231257),
(6, 'wakkaka', 'asda', 'ktp', '111111111', '', '', 0, '2-March-1956', '0819890061', '14g32', 'dfsdf@g4.com', 1231258),
(7, 'fergy', 'huang', 'ktp', '9991239123', '', '', 0, '22-August-1990', '0819639772', '81231', 'fergy@vadine.net', 1231259),
(8, 'test', 'test', 'ktp', '1212121212', 'gaharu', 'medan', 20235, '14-March-1957', '08216564', 'sdfsd33', 'support@mitrawebhost.com', 1231277);
...
(1, 'qwe', '$2y$10$0R9FJfyLUMqUETEruEaWa.S7Ik1UGRzbeY5iLyeI/FLvMTunXzStK', 'qwe@asd.com', '2015-06-20 17:28:07'),
(2, 'marvin', '$2y$10$0R9FJfyLUMqUETEruEaWa.S7Ik1UGRzbeY5iLyeI/FLvMTunXzStK', 'vnz_inside@aol.com', '2015-06-20 17:28:07');
...
--
ALTER TABLE `member`
MODIFY `m_no` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
